				...
				<view class="comment-box-item">
					...
					<view class="comment-main">
						...
						<view class="comment-main-foot">
							...
							<view class="foot-btn" @click="reply(item.userId,item.nickName,item.id)">回复</view>
							...
							<view class="comment-sub-item" v-for="(each,index) in item.children" :key="index">
								...
								<view class="comment-main">
									...
									<view class="comment-main-foot">
										...
										<view class="foot-btn" @click="reply(each.userId,item.nickName,item.id)">
											回复</view>
